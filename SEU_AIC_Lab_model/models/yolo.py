...
class Detect(nn.Module):
    ...
    def forward(self, x):
        ...
        return (x, seg_output) if self.training else (torch.cat(z, 1), (x, seg_output))
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, Shuffle_Block, conv_bn_relu_maxpool, DWConvblock]:
            c1, c2 = ch[f], args[0]
